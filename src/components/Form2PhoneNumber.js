          ...
          <tr key={item._id}>
            ...
            <td>
              ...
              <button
                ...
                onClick={async () => {
                  await axios.put(
                    `https://eigenheim-backend.herokuapp.com/create-form-edit/${item._id}`,
                    { Option: option }
                  );
                  console.log(option);
                }}
...
export default function FormPhoneNumbers() {
  ...
  useEffect(() => {
    // GET request using axios inside useEffect React hook
    let data = axios
      .get("https://eigenheim-backend.herokuapp.com/")
  ...
  return (
    <Auth>
      <div className="App">
        <h3 style={{ textAlign: "center" }}>Baufinanzierung Phone Numbers</h3>
